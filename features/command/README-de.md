...
Du kannst deine Webseite mit einem statischen Zwischenspeicher beschleunigen. Das beschleunigt eine dynamische Webseite, jedoch muss es immer wieder aktualisiert werden. Hier ist ein Beispiel: `php yellow.php build cache`, du kannst wahlweise einen Ort angeben. Zum Löschen gibt man ein: `php yellow.php clean cache`.
