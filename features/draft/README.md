...
Set `Status: draft` in the settings at the top of a page. The page will no longer be visible. You can continue to edit a draft page in the [web browser](https://github.com/datenstrom/yellow-extensions/tree/master/features/edit) and the file system.
