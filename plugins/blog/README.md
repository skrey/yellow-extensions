...
7. Add [page.txt](page.txt?raw=true), [2013-04-07-blog-example.txt](2013-04-07-blog-example.txt?raw=true) and [sidebar.txt](sidebar.txt?raw=true) to your `/content/3-blog` folder.
