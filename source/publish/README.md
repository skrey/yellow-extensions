...
If you want others to discover your extension, add [datenstrom-yellow](https://github.com/topics/datenstrom-yellow) to your repository and make an [announcement](https://github.com/datenstrom/yellow/discussions/categories/see-what-s-new).
