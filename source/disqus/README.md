...
This extension uses a service that collect personal data. There's the [comments extension](https://github.com/GiovanniSalmeri/yellow-comments) as an alternative.
